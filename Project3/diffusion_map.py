...
class DiffusionMap(object):
    ...
    def _compute_knn_sq_dists(self, X):
        ...
        sq_dists = sp_dist.pdist(X.T, 'sqeuclidean')
...
class MahalanobisDiffusionMap(DiffusionMap):
    ...
    def __init__(self, alpha=0, epsilon=0.1, num_evecs=1, pbc_dims=None,
                 n_neigh=None, load_covars=None, load_drifts=None, local_eps=None):
    ...
    def _compute_inv_chol_covs(self, N, dim, X=None):        
        """ Compute inverse cholesky factorization of input diffusion matrices
        Parameters
        ----------
        Returns
        -------
